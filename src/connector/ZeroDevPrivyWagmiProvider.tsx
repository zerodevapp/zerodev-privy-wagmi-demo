...
import { AccountParams } from "@zerodev/wagmi";
...
export const ZeroDevPrivyWagmiProvider: React.FC<ZeroDevPrivyWagmiProviderProps> = ({options, wagmiChainsConfig, children}) => {
    ...
    // Note: if you remove the privyConnectorOverride prop, the useWalletClient hook will eventually return the wallet clients
    // However, this is only if you set the active wallet.
    return (
